...
/**
 * Interface für Gedicht-Dokumente
 * Definiert die Typescript-Typen für alle Gedicht-Eigenschaften
 */
...
PoemSchema.methods = {
   ...
   */
  softDelete: async function(): Promise<void> {
   ...
   */
  createNewVersion: async function(): Promise<void> {
    this.version += 1;
    await this.save();
  }
};
