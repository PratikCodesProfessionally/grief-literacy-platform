...
} from "./chunk-XAHRHMVD.js";
import {
  Slot,
  useComposedRefs
} from "./chunk-LKHE5SAO.js";
import {
  require_jsx_runtime
...
var RemoveScroll = React22.forwardRef(function(props, parentRef) {
  var ref = React22.useRef(null);
  var _a = React22.useState({
  ...
  return React22.createElement(
    React22.Fragment,
    null,
    enabled && React22.createElement(SideCar2, { sideCar: effectCar, removeScrollBar, shards, noIsolation, inert, setCallbacks, allowPinchZoom: !!allowPinchZoom, lockRef: ref, gapMode }),
    forwardProps ? React22.cloneElement(React22.Children.only(children), __assign(__assign({}, containerProps), { ref: containerRef })) : React22.createElement(Container, __assign({}, containerProps, { className, ref: containerRef }), children)
  );
});
...
var Select = (props) => {
  ...
  const [valueNodeHasChildren, setValueNodeHasChildren] = React27.useState(false);
  ...
  const triggerPointerDownPosRef = React27.useRef(null);
  const isFormControl = trigger ? form || !!trigger.closest("form") : true;
  const [nativeOptionsSet, setNativeOptionsSet] = React27.useState(/* @__PURE__ */ new Set());
      ...
      children: [
        (0, import_jsx_runtime9.jsx)(Collection.Provider, { scope: __scopeSelect, children: (0, import_jsx_runtime9.jsx)(
          SelectNativeOptionsProvider,
          {
            ...
            onNativeOptionAdd: React27.useCallback((option) => {
              setNativeOptionsSet((prev) => new Set(prev).add(option));
            }, []),
            onNativeOptionRemove: React27.useCallback((option) => {
...
var SelectTrigger = React27.forwardRef(
  (props, forwardedRef) => {
    ...
    const pointerTypeRef = React27.useRef("touch");
...
var SelectValue = React27.forwardRef(
  (props, forwardedRef) => {
...
var SelectIcon = React27.forwardRef(
  (props, forwardedRef) => {
...
var SelectContent = React27.forwardRef(
  (props, forwardedRef) => {
    const context = useSelectContext(CONTENT_NAME2, props.__scopeSelect);
    const [fragment, setFragment] = React27.useState();
    useLayoutEffect2(() => {
...
var SelectContentImpl = React27.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSelect,
    ...
    const [selectedItemText, setSelectedItemText] = React27.useState(
      null
    );
    const getItems = useCollection(__scopeSelect);
    const [isPositioned, setIsPositioned] = React27.useState(false);
    const firstValidItemFoundRef = React27.useRef(false);
    React27.useEffect(() => {
      if (content) return hideOthers(content);
    }, [content]);
    useFocusGuards();
    const focusFirst2 = React27.useCallback(
      (candidates) => {
    ...
    const focusSelectedItem = React27.useCallback(
    ...
    const itemRefCallback = React27.useCallback(
      (node, value, disabled) => {
    ...
    const handleItemLeave = React27.useCallback(() => content == null ? void 0 : content.focus(), [content]);
    const itemTextRefCallback = React27.useCallback(
      (node, value, disabled) => {
        const isFirstValidItem = !firstValidItemFoundRef.current && !disabled;
        const isSelectedItem = context.value !== void 0 && context.value === value;
        if (isSelectedItem || isFirstValidItem) {
...
var SelectItemAlignedPosition = React27.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, onPlaced, ...popperProps } = props;
  const context = useSelectContext(CONTENT_NAME2, __scopeSelect);
  const contentContext = useSelectContentContext(CONTENT_NAME2, __scopeSelect);
  const [contentWrapper, setContentWrapper] = React27.useState(null);
  const [content, setContent] = React27.useState(null);
  const composedRefs = useComposedRefs(forwardedRef, (node) => setContent(node));
  const getItems = useCollection(__scopeSelect);
  const shouldExpandOnScrollRef = React27.useRef(false);
  const shouldRepositionRef = React27.useRef(true);
  const { viewport, selectedItem, selectedItemText, focusSelectedItem } = contentContext;
  const position = React27.useCallback(() => {
  ...
  const handleScrollButtonChange = React27.useCallback(
    (node) => {
...
var SelectPopperPosition = React27.forwardRef((props, forwardedRef) => {
  const {
    __scopeSelect,
    align = "start",
...
var SelectViewport = React27.forwardRef(
  (props, forwardedRef) => {
    const { __scopeSelect, nonce, ...viewportProps } = props;
    const contentContext = useSelectContentContext(VIEWPORT_NAME, __scopeSelect);
    const viewportContext = useSelectViewportContext(VIEWPORT_NAME, __scopeSelect);
    const composedRefs = useComposedRefs(forwardedRef, contentContext.onViewportChange);
    const prevScrollTopRef = React27.useRef(0);
...
var SelectItem = React27.forwardRef(
  (props, forwardedRef) => {
    ...
    const [textValue, setTextValue] = React27.useState(textValueProp ?? "");
    ...
    return (0, import_jsx_runtime9.jsx)(
      SelectItemContextProvider,
      {
        ...
        textId,
        isSelected,
        onItemTextChange: React27.useCallback((node) => {
...
var SelectItemText = React27.forwardRef(
  (props, forwardedRef) => {
    ...
    const [itemTextNode, setItemTextNode] = React27.useState(null);
    const composedRefs = useComposedRefs(
      forwardedRef,
    ...
    const nativeOption = React27.useMemo(
...
var SelectScrollUpButton = React27.forwardRef((props, forwardedRef) => {
  const contentContext = useSelectContentContext(SCROLL_UP_BUTTON_NAME, props.__scopeSelect);
  const viewportContext = useSelectViewportContext(SCROLL_UP_BUTTON_NAME, props.__scopeSelect);
  const [canScrollUp, setCanScrollUp] = React27.useState(false);
...
var SelectScrollDownButton = React27.forwardRef((props, forwardedRef) => {
  const contentContext = useSelectContentContext(SCROLL_DOWN_BUTTON_NAME, props.__scopeSelect);
  const viewportContext = useSelectViewportContext(SCROLL_DOWN_BUTTON_NAME, props.__scopeSelect);
  const [canScrollDown, setCanScrollDown] = React27.useState(false);
  const composedRefs = useComposedRefs(forwardedRef, viewportContext.onScrollButtonChange);
  useLayoutEffect2(() => {
    if (contentContext.viewport && contentContext.isPositioned) {
      let handleScroll22 = function() {
...
var SelectScrollButtonImpl = React27.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, onAutoScroll, ...scrollIndicatorProps } = props;
  const contentContext = useSelectContentContext("SelectScrollButton", __scopeSelect);
  const autoScrollTimerRef = React27.useRef(null);
  const getItems = useCollection(__scopeSelect);
  const clearAutoScrollTimer = React27.useCallback(() => {
...
var SelectSeparator = React27.forwardRef(
  (props, forwardedRef) => {
...
var SelectArrow = React27.forwardRef(
  (props, forwardedRef) => {
...
var BubbleSelect = React27.forwardRef(
  (props, forwardedRef) => {
...
function useTypeaheadSearch(onSearchChange) {
  ...
  const handleTypeaheadSearch = React27.useCallback(
    (key) => {
  ...
  const resetTypeahead = React27.useCallback(() => {
    searchRef.current = "";
    window.clearTimeout(timerRef.current);
  }, []);
  React27.useEffect(() => {
