...
router.post('/password-reset-request', authLimiter, (req, res) => userController.requestPasswordReset(req, res));
// POST /api/users/password-reset - Passwort zurücksetzen
router.post('/password-reset', authLimiter, (req, res) => userController.resetPassword(req, res));
// PUT /api/users/me - Profil aktualisieren
router.put('/me', auth.verified, (req, res) => userController.updateProfile(req, res));
// DELETE /api/users/me - Profil löschen
router.delete('/me', auth.verified, (req, res) => userController.deleteProfile(req, res));
